...
// module
exports.push([module.i, ".word {\n  color: blue;\n  border: 2px solid yellow; }\n\n.wrap {\n  color: red;\n  background: url(" + __webpack_require__(60) + ") center center no-repeat; }\n", ""]);
...
module.exports = {
	...
	getComponent: function getComponent(nextState, callback) {
		__webpack_require__.e/* import() */(0).then(__webpack_require__.bind(null, 133)).then(function (module) {
...
module.exports = {
	path: 'set',
	getComponent: function getComponent(nextState, callback) {
		__webpack_require__.e/* import() */(1).then(__webpack_require__.bind(null, 134)).then(function (module) {
			return callback(null, module.default);
		});
	}
};
...
var Index = (_dec = (0, _reactRedux.connect)(function (state) {
	...
	(0, _createClass3.default)(Index, [{
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						_reactRouter.Link,
						{ to: '/' },
						'This is Homepage.HAHAHAHAHAHAHAHAHAHAH'
					)
				),
				_react2.default.createElement(
					'p',
		...
		value: function fetchData() {
			return _promise2.default.all([dispatch(asyncAction)]);
		}
	}]);
	return Index;
...
var _ejs = __webpack_require__(64);
...
var _init = __webpack_require__(62);

var _init2 = _interopRequireDefault(_init);

var _init3 = __webpack_require__(61);
